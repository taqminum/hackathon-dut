...
# 默认用约 1.7 QPS 的保守节奏避免 10021（CUQPS_HAS_EXCEEDED_THE_LIMIT），
# 同时保留环境变量覆盖，方便按 Key 档位调高或调低。
AMAP_MIN_INTERVAL_SECONDS = float(os.getenv("AMAP_MIN_INTERVAL_SECONDS", "0.6"))
